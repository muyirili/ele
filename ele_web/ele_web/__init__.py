...
from ele_web.blueprints.admin import admin_bp
from ele_web.blueprints.auth import auth_bp
from ele_web.blueprints.chat import chat_bp
from ele_web.blueprints.oauth import oauth_bp
from ele_web.blueprints.ele import ele_bp
from ele_web.extensions import db, login_manager, csrf, socketio, moment, oauth
from ele_web.models import User, Message
from ele_web.settings import config
